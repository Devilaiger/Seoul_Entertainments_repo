...
open class AnimeSeoulProvider : MainAPI() {
    override var mainUrl = "https://animeflix.dad"
    override var name = "Anime Seoul"
        ...
        val basemainUrl: String? by lazy {
            runBlocking {
                try {
                    ...
                    val domain = doc.select("span.badge:contains(animeflix)").firstOrNull()?.text()?.trim()
                        ?: doc.select("a[href*='type=animeflix']").firstOrNull()?.parent()?.selectFirst("span.badge")?.text()?.trim()
                ...
                try {
                    ...
                    val opt = jsonObject.optString("animeflix")
    ...
    override val mainPage = mainPageOf(
        "/page/" to "Home",
        "/anime-series/page/" to "Anime Series",
        "/anime-movies/page/" to "Anime Movies",
        "/donghua/page/" to "Donghua",
        "/category/hindi-sub/page/" to "Hindi Subbed",
    )
