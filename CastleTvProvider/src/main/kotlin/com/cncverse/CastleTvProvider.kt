...
class CastleTvProvider : MainAPI() {
    ...
    private val keySupFixx = if (BuildConfig.CASTLE_SUFFIX.isNotBlank()) BuildConfig.CASTLE_SUFFIX else "T!BgJB"
    ...
    override suspend fun loadLinks(
        ...
        return try {
            ...
            // Available resolutions to try (720P and 480P, skipping 1080P which requires Castle TV Premium)
            val resolutions = listOf(2, 1)
