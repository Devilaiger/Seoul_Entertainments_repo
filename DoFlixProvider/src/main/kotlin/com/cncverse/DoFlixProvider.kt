...
class DoFlixProvider : MainAPI() {
    ...
    override suspend fun search(query: String): List<com.seoulentertainment.app.SearchResponse> {
        
        val searchResults = mutableListOf<com.seoulentertainment.app.SearchResponse>()
