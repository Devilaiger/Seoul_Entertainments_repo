...
import com.seoulentertainment.app.LoadResponse.Companion.addImdbId
import com.seoulentertainment.app.LoadResponse.Companion.addTMDbId
...
import com.seoulentertainment.app.addDate
...
import com.seoulentertainment.app.base64Encode
...
import com.seoulentertainment.app.newSearchResponseList
...
import com.seoulentertainment.app.ui.settings.Globals.TV
import com.seoulentertainment.app.ui.settings.Globals.isLayout
class MovieBoxProvider : MainAPI() {
    companion object {
        ...
        @Volatile var storedToken: String? = null
    }
    ...
    private suspend fun getOrFetchToken(): String? {
        ...
        try {
            ...
            val brandModel = randomBrandModel()
            val headers = mapOf(
                "user-agent" to "com.community.mbox.in/50020042 (Linux; U; Android 16; en_IN; ${brandModel.model}; Build/BP22.250325.006; Cronet/133.0.6876.3)",
                "accept" to "application/json",
                "content-type" to "application/json",
                "connection" to "keep-alive",
                "x-client-token" to xClientToken,
                "x-tr-signature" to xTrSignature,
                "x-client-info" to """{"package_name":"com.community.mbox.in","version_name":"3.0.03.0529.03","version_code":50020042,"os":"android","os_version":"16","device_id":"$deviceId","install_store":"ps","gaid":"d7578036d13336cc","brand":"${brandModel.brand}","model":"${brandModel.model}","system_language":"en","net":"NETWORK_WIFI","region":"IN","timezone":"Asia/Calcutta","sp_code":""}""",
...
bo                    newMovieSearchResponse(
    ...
    override suspend fun loadLinks(
        ...
        val token = getOrFetchToken()
        val brandModel = randomBrandModel()
        val brand = brandModel.brand
        val model = brandModel.model
        ...
        try {
            ...
            val subjectHeaders = mutableMapOf(
                "user-agent" to "com.community.oneroom/50020088 (Linux; U; Android 13; en_US; $model; Build/TQ3A.230901.001; Cronet/145.0.7582.0)",
                "accept" to "application/json",
                "content-type" to "application/json",
                "connection" to "keep-alive",
            ...
            if (token.isNullOrBlank()) {
                token = storedToken ?: getOrFetchToken()
            }
