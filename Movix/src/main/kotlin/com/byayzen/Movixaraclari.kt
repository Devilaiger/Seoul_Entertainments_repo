...
object MovixHelper {
    @Volatile var cachedUrl: String? = "https://movix.show"
    ...
    suspend fun updatemainurl(): String {
        ...
        return cachedUrl ?: "https://movix.show"
    }
}
...
data class MovixLinksApiResponse(
    val success: Boolean? = null,
    val type: String? = null,
    val data: List<MovixLinksData>? = null
)

data class MovixLinksData(
    val id: Any? = null,
    val series_id: String? = null,
    val season_number: Int? = null,
    val episode_number: Int? = null,
    val links: List<MovixLinkItem>? = null
)

data class MovixLinkItem(
    val url: String? = null,
