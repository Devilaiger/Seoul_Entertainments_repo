...
class StreamFlixProvider : MainAPI() {
    ...
    private suspend fun getEpisodesFromWebSocket(movieKey: String, totalSeasons: Int = 1): List<com.seoulentertainment.app.Episode> {
        val episodes = mutableListOf<com.seoulentertainment.app.Episode>()
