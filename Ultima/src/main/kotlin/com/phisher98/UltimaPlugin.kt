...
import com.seoulentertainment.app.MainActivity
import com.lagradost.cloudstream3.plugins.CloudstreamPlugin
import com.seoulentertainment.app.plugins.Plugin
import com.seoulentertainment.app.ui.home.HomeViewModel.Companion.getResumeWatching
...
import com.seoulentertainment.app.CommonActivity.showToast
...
class UltimaPlugin : Plugin() {
    ...
    fun startSseListener(context: Context, force: Boolean = false) {
        ...
        synchronized(sseLock) {
            ...
            val sseClient = com.seoulentertainment.app.app.baseClient.newBuilder()
