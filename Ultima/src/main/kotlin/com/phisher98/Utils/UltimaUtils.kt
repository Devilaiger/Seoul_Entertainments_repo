...
object UltimaUtils {
    fun getAllProviders(): List<com.seoulentertainment.app.MainAPI> {
        try {
            val clazz = Class.forName("com.seoulentertainment.app.APIHolder")
            ...
            for (method in clazz.declaredMethods) {
                if (method.name == "getAllProviders" || method.name == "getProviders" || method.name == "getApis") {
                    ...
                    if (result is List<*>) {
                        return result.filterIsInstance<com.seoulentertainment.app.MainAPI>()
                    }
                    if (result is Array<*>) {
                        return result.filterIsInstance<com.seoulentertainment.app.MainAPI>()
                    }
        ...
        return try {
            com.seoulentertainment.app.APIHolder.allProviders
        } catch (e: Throwable) {
            emptyList()
        }
    }
